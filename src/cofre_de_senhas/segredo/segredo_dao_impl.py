...
class SegredoDAOImpl(SegredoDAO):
    ...
    def buscar_por_pk(self, pk: SegredoPK) -> DadosSegredo | None:
        ...
        return self._raiz.fetchone_class(DadosSegredo)
    ...
    def listar(self) -> list[DadosSegredo]:
        ...
        return self._raiz.fetchall_class(DadosSegredo)

    @override
    def criar(self, dados: DadosSegredoSemPK) -> SegredoPK:
        sql: str = "INSERT INTO segredo (nome, descricao, fk_tipo_segredo) VALUES (?, ?, ?)"
        self._raiz.execute(sql, [dados.nome, dados.descricao, dados.fk_tipo_segredo])
        return SegredoPK(self._raiz.asserted_lastrowid)
    ...
    def salvar_com_pk(self, dados: DadosSegredo) -> bool:
        ...
        self._raiz.execute(sql, [dados.pk_segredo, dados.nome, dados.descricao, dados.fk_tipo_segredo, dados.pk_segredo])
    ...
    def limpar_segredo(self, pk: SegredoPK) -> None:
        ...
        self._raiz.execute(sql1, [pk.pk_segredo])
        self._raiz.execute(sql2, [pk.pk_segredo])
        self._raiz.execute(sql3, [pk.pk_segredo])
    ...
    def listar_por_pks(self, pks: list[SegredoPK]) -> list[DadosSegredo]:
        ...
        self._raiz.execute(sql, [pk.pk_segredo for pk in pks])
        return self._raiz.fetchall_class(DadosSegredo)
    ...
    def criar_categoria_segredo(self, c: CategoriaDeSegredo) -> bool:
        ...
        self._raiz.execute(sql, [c.pk_segredo, c.pk_categoria])
        return self._raiz.rowcount > 0
    ...
    def criar_campo_segredo(self, campo: CampoDeSegredo) -> bool:
        ...
        self._raiz.execute(sql, [campo.pfk_segredo, campo.pk_nome, campo.valor])
        return self._raiz.rowcount > 0
    ...
    def ler_campos_segredo(self, pk: SegredoPK) -> list[CampoDeSegredo]:
        ...
        self._raiz.execute(sql, [pk.pk_segredo])
        return self._raiz.fetchall_class(CampoDeSegredo)
    ...
    def criar_permissao(self, permissao: PermissaoDeSegredo) -> bool:
        ...
        self._raiz.execute(sql, [permissao.pfk_usuario, permissao.pfk_segredo, permissao.fk_tipo_permissao])
        return self._raiz.rowcount > 0
    ...
    def buscar_permissao(self, busca: BuscaPermissaoPorLogin) -> PermissaoDeSegredo | None:
        ...
        self._raiz.execute(sql, [busca.pfk_segredo, busca.login])
        return self._raiz.fetchone_class(PermissaoDeSegredo)